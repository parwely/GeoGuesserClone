  ...
  try {
    ...
    if (locations.length > 0) {
      ...
      if (streetViewData.static?.url) {
        console.log(
          "   - Static URL length:",
          streetViewData.static.url.length
        );
        console.log(
          "   - Contains API key:",
          streetViewData.static.url.includes("key=")
        );
        console.log(
          "   - URL preview:",
      ...
      console.log(
        "   - Mobile detected:",
        mobileData.context?.isMobile || "not specified"
      );
    ...
    console.log(
      "✅ All guaranteed Street View locations are working correctly"
    );
