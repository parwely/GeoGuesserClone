...
console.log(
  "- Mobile URL size:",
  desktopUrls.mobile.includes("400x400") ? "400x400" : "other"
);
console.log(
  "- Tablet URL size:",
  desktopUrls.tablet.includes("640x640") ? "640x640" : "other"
);
...
console.log(
  "- Mobile URL size:",
  mobileGoodUrls.mobile.includes("400x400")
    ? "400x400"
    : mobileGoodUrls.mobile.includes("640x640")
    ? "640x640"
    : "other"
);
...
console.log(
  "- Mobile URL size:",
  mobileProblematicUrls.mobile.includes("400x400")
    ? "400x400"
    : mobileProblematicUrls.mobile.includes("640x640")
    ? "640x640"
    : "other"
);
console.log(
  "- Fallback applied due to location:",
  streetViewService.shouldUseMobileFallback(25.0, 0.0)
);

// Test 4: High quality preference
console.log("\n=== TEST 4: Mobile with High Quality Preference ===");
const mobileHighQualityUrls =
  streetViewService.generateResponsiveUrlsWithContext(
    testCoordinates.latitude,
    testCoordinates.longitude,
    90,
...
console.log(
  "- Mobile URL size:",
  mobileHighQualityUrls.mobile.includes("400x400")
    ? "400x400"
    : mobileHighQualityUrls.mobile.includes("640x640")
    ? "640x640"
    : "other"
);
console.log(
  "- High quality applied:",
  mobileHighQualityUrls.mobile === mobileHighQualityUrls.tablet
);
