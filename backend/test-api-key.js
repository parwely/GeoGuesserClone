...
console.log('GOOGLE_STREETVIEW_API_KEY:', process.env.GOOGLE_STREETVIEW_API_KEY);
...
console.log('Key length:', streetViewService.apiKey ? streetViewService.apiKey.length : 'undefined');